...
public class LauncherPermission {
    private Context context;

    public LauncherPermission(Context context) {
    ...
    public void clearDefaultLauncher() {
        ...
        String hn = EmptyActivity.class.getName();
...
//            clearDefaultLauncher();
            ...
            if (!res.activityInfo.packageName.equals("hansysu.mylauncher")) {
//                clearDefaultLauncher();
                SetDefaultLauncher();
            }
